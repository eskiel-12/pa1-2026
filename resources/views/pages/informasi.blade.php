...
<style>
    ...
    .informasi-hero {
        height: 60vh;
        min-height: 450px;
        background: linear-gradient(135deg, rgba(0,51,102,0.9), rgba(10,74,122,0.9)), url('/image/informasi-hero.jpg');
    ...
    .bg-light {
        background: linear-gradient(135deg, #e0ecf7 0%, #d4e4f2 100%);
    }
        ...
        <div class="sejarah-grid">
            ...
            <div class="sejarah-item" data-aos="fade-right">
                ...
                <div class="sejarah-text">
                    <p>
                        Danau Toba terbentuk akibat letusan gunung berapi super
                        (supervolcano) yang terjadi sekitar 74.000 tahun lalu.
                        Letusan ini merupakan salah satu letusan terbesar dalam
                        sejarah bumi yang meninggalkan kaldera raksasa yang kini
                        dikenal sebagai Danau Toba. Material vulkanik dari
                        letusan ini tersebar hingga ke berbagai belahan dunia,
                        termasuk India dan Afrika.
                    </p>
                </div>
            </div>
            ...
            <div class="sejarah-item reverse" data-aos="fade-left">
                ...
                <div class="sejarah-text">
                    <p>
                        Letusan supervolcano Toba menghasilkan kaldera dengan
                        panjang 100 km dan lebar 30 km. Setelah letusan,
                        kaldera perlahan terisi air dan membentuk Danau Toba
                        yang kita kenal sekarang. Proses pengangkatan kembali
                        dasar kaldera kemudian menciptakan Pulau Samosir di
                        tengah danau, yang menjadikan Danau Toba unik di dunia.
                    </p>
                </div>
            </div>
            ...
            <div class="sejarah-item" data-aos="fade-right">
                ...
                <div class="sejarah-text">
                    <p>
                        Kawasan Danau Toba kini diakui UNESCO sebagai Global
                        Geopark pada tahun 2020. Pengakuan ini diberikan karena
                        nilai geologi yang luar biasa, keanekaragaman hayati,
                        serta warisan budaya Batak yang masih terjaga hingga
                        saat ini.
                    </p>
                </div>
            </div>
        ...
        <div class="timeline">
            ...
            <div class="timeline-item" data-aos="fade-up">
                ...
                <div class="timeline-desc">
                    Menghasilkan batuan Haranggaol Dacite Tuff (HDT)
                    di Kaldera Haranggaol
                </div>
            </div>
            ...
            <div class="timeline-item" data-aos="fade-up" data-aos-delay="50">
                ...
                <div class="timeline-desc">
                    Menghasilkan batuan Tuff Toba Tertua (OTT)
                    di Kaldera Porsea
                </div>
            </div>
            ...
            <div class="timeline-item" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="timeline-desc">
                    Menghasilkan batuan Tuff Toba Tengah (MTT)
                    di Kaldera Haranggaol
                </div>
            </div>
            ...
            <div class="timeline-item" data-aos="fade-up" data-aos-delay="150">
                ...
                <div class="timeline-desc">
                    Letusan supervolcano yang membentuk Kaldera Toba (YTT)
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="fakta-grid">
            ...
            <div class="fakta-card" data-aos="fade-up" data-aos-delay="50">
                ...
                <div class="fakta-desc">
                    Pulau Samosir adalah pulau di tengah danau terbesar di dunia
                </div>
            </div>
            ...
            <div class="fakta-card" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="fakta-desc">
                    Diakui UNESCO sejak tahun 2020
                </div>
            </div>
        ...
        <div class="informasi-grid">
            ...
            <div class="informasi-card">
                ...
                <div class="informasi-content">
                    ...
                    <h3 class="informasi-title">{{ $item->judul }}</h3>
                    <p class="informasi-excerpt">{{ Str::limit(strip_tags($item->konten), 150) }}</p>
                    <a href="{{ route('informasi.detail', $item->slug) }}" class="informasi-readmore">
                        Baca Selengkapnya →
                    </a>
                </div>
            </div>
            ...
            <div class="empty-state">
                ...
                <p>Saat ini belum ada informasi yang tersedia.</p>
