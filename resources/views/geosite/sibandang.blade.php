    ...
    <style>
        * {
        ...
        @media (max-width: 768px) {
            ...
            .rute-info { flex-direction: column; text-align: center; }
        }
...
<section class="hero">
    <div>
        <h1 class="hero-title">Sibandang</h1>
...
<section id="sejarah" class="section">
    <div class="container">
        ...
        <div class="sejarah-item">
            <div class="sejarah-image"><img src="{{ asset('uploads/A6.JPG') }}" alt="Sibandang"></div>
        ...
        <div class="grid-3">
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <h3>{{ $item->nama }}</h3>
                    <p>{{ $item->deskripsi }}</p>
                    <div class="card-location"><i class="fas fa-map-marker-alt"></i> {{ $item->lokasi }}</div>
                    <div class="card-contact"><i class="fas fa-phone"></i> {{ $item->kontak }}</div>
                </div>
            </div>
            @endforeach
        </div>
        ...
        <div class="grid-3">
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="card-contact"><i class="fas fa-phone"></i> +62 813-7682-1631</div>
                </div>
            </div>
            <div class="card">
        ...
        <div class="grid-2">
            ...
            <div class="fasilitas-item">
                ...
                <div class="fasilitas-content">
                    <h4>Warung Makan</h4>
                    <p>Kuliner khas</p>
                    <div class="fasilitas-price">Mulai Rp 15.000</div>
                </div>
            </div>
            <div class="fasilitas-item">
                ...
                <div class="fasilitas-content">
                    <h4>Area Camping</h4>
                    <p>View danau</p>
                    <div class="fasilitas-price">Rp 25.000</div>
                </div>
            </div>
            <div class="fasilitas-item">
...
<section id="lokasi" class="section bg-light">
    <div class="container">
        ...
        <div class="maps-section">
            ...
            <div class="rute-info">
                <div class="rute-item"><h4>Motor</h4><p>Balige ke Ajibata (30m) ke Ferry (20m) ke Sibandang (15m)</p></div>
