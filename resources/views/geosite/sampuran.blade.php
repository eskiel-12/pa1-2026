...
<head>
    ...
    <title>Sampuran - Geosite Danau Toba</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .galeri-tabs { display: flex; justify-content: center; gap: 15px; margin-bottom: 35px; }
...
<section id="sejarah" class="section">
    <div class="container">
        ...
        <div class="sejarah-item">
            <div class="sejarah-image"><img src="{{ asset('uploads/A6.JPG') }}" alt="Sampuran"></div>
            <div class="sejarah-text"><p>Sampuran adalah salah satu desa di Kecamatan Muara, Kabupaten Tapanuli Utara, yang terletak di Pulau Sibandang. Desa ini berada di dataran tinggi dengan udara sejuk dan pemandangan Danau Toba yang menakjubkan.</p></div>
        </div>
        <div class="sejarah-item reverse">
            <div class="sejarah-image"><img src="{{ asset('uploads/A3.JPG') }}"></div>
            <div class="sejarah-text"><p>Mayoritas penduduk Sampuran bekerja sebagai petani dengan komoditas seperti padi, jagung, dan tanaman hortikultura. Kehidupan masyarakat masih kental dengan semangat gotong royong dan adat istiadat Batak.</p></div>
        </div>
        <div class="sejarah-item">
            <div class="sejarah-image"><img src="{{ asset('uploads/A4.JPG') }}"></div>
            <div class="sejarah-text"><p>Dari ketinggian Desa Sampuran, pengunjung dapat menikmati panorama Danau Toba dengan latar Pulau Samosir di kejauhan, menjadikannya spot ideal untuk fotografi lanskap.</p></div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="grid-3">
            <div class="card">
                ...
                <div class="card-content"><h3>Tenun Ulos</h3><p>Kain tenun khas Batak.</p><div class="card-location"><i class="fas fa-map-marker-alt"></i> Desa Sampuran</div></div>
            </div>
            <div class="card">
                <img src="{{ asset('uploads/A1.jpeg') }}" class="card-img">
                <div class="card-content"><h3>Anyaman Bambu</h3><p>Kerajinan tangan dari bambu.</p><div class="card-location"><i class="fas fa-map-marker-alt"></i> Desa Sampuran</div></div>
            </div>
            <div class="card">
                <img src="{{ asset('uploads/A2.JPG') }}" class="card-img">
                <div class="card-content"><h3>Madu Hutan</h3><p>Madu alami dari hutan sekitar.</p><div class="card-location"><i class="fas fa-map-marker-alt"></i> Kawasan Hutan</div></div>
            </div>
        </div>
    </div>
</section>
...
<section id="penginapan" class="section">
    <div class="container">
        ...
        <div class="grid-3">
            <div class="card"><img src="{{ asset('uploads/A3.JPG') }}" class="card-img"><div class="card-content"><h3>Homestay Sampuran</h3><p>Menginap dengan pemandangan Danau Toba.</p></div></div>
            <div class="card"><img src="{{ asset('uploads/A4.JPG') }}" class="card-img"><div class="card-content"><h3>Lake View Homestay</h3><p>Pemandangan langsung Danau Toba.</p></div></div>
            <div class="card"><img src="{{ asset('uploads/A5.JPG') }}" class="card-img"><div class="card-content"><h3>Sampuran Lodge</h3><p>Tradisional dengan fasilitas modern.</p></div></div>
        </div>
    </div>
</section>
...
<section id="fasilitas" class="section bg-light">
    <div class="container">
        ...
        <div class="grid-2">
            ...
            <div class="fasilitas-item"><img src="{{ asset('uploads/A4.JPG') }}" class="fasilitas-img"><div class="fasilitas-content"><h4>Area Camping</h4><p>View danau</p><div class="fasilitas-price">Rp 25.000</div></div></div>
        </div>
    </div>
</section>
...
<section id="lokasi" class="section bg-light">
    <div class="container">
        ...
        <div class="maps-section">
            <div class="maps-container"><iframe src="https://maps.google.com/maps?q=Sampuran,+Tapanuli+Utara&output=embed" allowfullscreen loading="lazy"></iframe></div>
            <div class="rute-info">
                <div class="rute-item"><h4>Motor</h4><p>Dari dermaga Muara ke Sampuran (25 menit)</p></div>
                <div class="rute-item"><h4>Mobil</h4><p>Jalan desa berbukit, disarankan motor</p></div>
...
<section class="cta">
    <div class="container">
        <h3>Kunjungi Sampuran Sekarang</h3>
