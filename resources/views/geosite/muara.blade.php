...
<head>
    ...
    <title>Muara - Geosite Danau Toba</title>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=Cormorant+Garamond:wght@400;500;600;700&display=swap" rel="stylesheet">
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: 'Inter', sans-serif; background: #fafaf8; }

        .navbar { position: fixed; top: 0; left: 0; width: 100%; z-index: 1000; background: rgba(255,255,255,0.95); backdrop-filter: blur(10px); border-bottom: 1px solid rgba(0,0,0,0.05); padding: 16px 0; transition: all 0.3s ease; }
        ...
        .logo-text h4 { font-size: 0.9rem; font-weight: 700; letter-spacing: 1.5px; color: #1a1a1a; }
        .logo-text p { font-size: 0.4rem; font-weight: 400; color: #888; }
        ...
        .nav-link.active { color: #c6a43b; border-bottom: 2px solid #c6a43b; }
        ...
        .mobile-overlay { position: fixed; top: 0; right: -100%; width: 280px; height: 100vh; background: rgba(255,255,255,0.98); backdrop-filter: blur(12px); z-index: 1001; transition: right 0.3s ease; box-shadow: -5px 0 30px rgba(0,0,0,0.1); padding: 80px 30px 30px; }
        ...
        .card-content p { color: #666; font-size: 0.8rem; line-height: 1.5; margin-bottom: 8px; }
        .card-location, .card-price, .card-contact, .card-address { font-size: 0.7rem; color: #888; margin-top: 5px; }
        ...
        .galeri-tabs { display: flex; justify-content: center; gap: 15px; margin-bottom: 35px; flex-wrap: wrap; }
        .tab-btn { background: transparent; border: none; padding: 8px 28px; font-size: 0.8rem; font-weight: 500; color: #555; cursor: pointer; border-radius: 40px; transition: 0.3s; }
        .tab-btn:hover, .tab-btn.active { background: #c6a43b; color: #1a1a1a; }
        ...
        .footer-logo { display: flex; justify-content: center; align-items: center; gap: 16px; margin-bottom: 20px; flex-wrap: wrap; }
        ...
        @media (max-width: 900px) { .nav-menu { gap: 25px; } .hero-title { font-size: 3rem; } }
        @media (max-width: 768px) { .nav-menu { display: none; } .hamburger { display: block; } .nav-logo { gap: 12px; } .flag-img { width: 50px; } .del-img { width: 28px; } .logo-text h4 { font-size: 0.8rem; } .hero { margin-top: 65px; min-height: 350px; } .hero-title { font-size: 2.5rem; } .section { padding: 50px 0; } .grid-3, .grid-2 { grid-template-columns: 1fr; } .galeri-grid { grid-template-columns: repeat(2, 1fr); } .sejarah-item, .sejarah-item.reverse { flex-direction: column; text-align: center; } .sejarah-image img { height: 220px; } .section-title h2 { font-size: 1.8rem; } .rute-info { flex-direction: column; text-align: center; } }
        @media (max-width: 576px) { .nav-logo { gap: 8px; } .flag-img { width: 40px; } .del-img { width: 22px; } .logo-divider { height: 20px; } .logo-text h4 { font-size: 0.7rem; } .hero { min-height: 300px; } .hero-title { font-size: 2rem; } .hero-subtitle { font-size: 0.65rem; } .cta h3 { font-size: 1.4rem; } .galeri-grid { gap: 10px; } .tab-btn { padding: 6px 18px; font-size: 0.7rem; } }
    </style>
</head>
<body>
...
<section id="sejarah" class="section">
    <div class="container">
        ...
        <div class="sejarah-item">
            <div class="sejarah-image"><img src="{{ asset('uploads/A6.JPG') }}" alt="Muara"></div>
            <div class="sejarah-text"><p>Muara adalah salah satu kecamatan di Kabupaten Tapanuli Utara yang berada di Provinsi Sumatera Utara, Indonesia. Kecamatan ini memiliki posisi geografis yang sangat strategis karena terletak langsung di tepian Danau Toba.</p></div>
        </div>
        <div class="sejarah-item reverse">
            <div class="sejarah-image"><img src="{{ asset('uploads/A3.JPG') }}"></div>
            <div class="sejarah-text"><p>Secara administratif, pusat pemerintahan Muara berada di Desa Huta Nagodang. Muara terdiri dari 15 desa: Aritonang, Batu Binumbun, Dolok Martumbur, Huta Ginjang, Huta Lontung, Huta Nagodang, Bariba Niaek, Papande, Sampuran, Sibandang, Silali Toruan, Silando, Simatupang, Sitanggor, dan Unte Mungkur.</p></div>
        </div>
        <div class="sejarah-item">
            <div class="sejarah-image"><img src="{{ asset('uploads/A4.JPG') }}"></div>
            <div class="sejarah-text"><p>Pulau Sibandang yang berada di tengah Danau Toba termasuk dalam wilayah kecamatan ini. Kondisi alam yang didominasi perbukitan dan perairan menjadikan Muara memiliki potensi besar di sektor pariwisata, perikanan, serta pertanian tradisional.</p></div>
        </div>
    </div>
</section>
        ...
        <div class="grid-3">
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="card-location"><i class="fas fa-map-marker-alt"></i> Muara, Huta Nagodang</div>
                    <div class="card-contact"><i class="fas fa-phone"></i> [KONTAK_UMKM1]</div>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="card-location"><i class="fas fa-map-marker-alt"></i> Desa Meat</div>
                    <div class="card-contact"><i class="fas fa-phone"></i> [KONTAK_UMKM2]</div>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="card-location"><i class="fas fa-map-marker-alt"></i> Kawasan Hutan</div>
                    <div class="card-contact"><i class="fas fa-phone"></i> [KONTAK_UMKM3]</div>
                </div>
            </div>
        </div>
    </div>
...
<section id="penginapan" class="section">
    <div class="container">
        <div class="section-title"><h2>Homestay</h2><div class="divider"></div></div>
        <div class="grid-3">
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="card-contact"><i class="fas fa-phone"></i> [KONTAK_HOMESTAY]</div>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="card-contact"><i class="fas fa-phone"></i> 085361006767</div>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="card-contact"><i class="fas fa-phone"></i> 081380002791</div>
                </div>
            </div>
            <div class="card">
                <img src="{{ asset('uploads/A5.JPG') }}" class="card-img">
                <div class="card-content">
                    ...
                    <p>Tradisional dengan fasilitas modern.</p>
                    <div class="card-price">[HARGA3] / malam</div>
                    <div class="card-contact"><i class="fas fa-phone"></i> 081375533336</div>
                </div>
            </div>
        </div>
    </div>
...
<section id="fasilitas" class="section bg-light">
    <div class="container">
        <div class="section-title"><h2>Akomodasi & Transportasi</h2><div class="divider"></div></div>
        <div class="grid-2">
            <div class="fasilitas-item">
                <img src="{{ asset('uploads/A1.jpeg') }}" class="fasilitas-img">
                <div class="fasilitas-content"><h4>Pelabuhan</h4><p>Luas dan aman</p><div class="fasilitas-price">Pelabuhan Milik Pemerintah</div></div>
            </div>
            <div class="fasilitas-item">
                <img src="{{ asset('uploads/A3.JPG') }}" class="fasilitas-img">
                <div class="fasilitas-content"><h4>Rumah Makan</h4><p>Kuliner khas Batak</p><div class="fasilitas-price">Rumah Makan</div></div>
            </div>
            <div class="fasilitas-item">
                <img src="{{ asset('uploads/A4.JPG') }}" class="fasilitas-img">
                <div class="fasilitas-content"><h4>Resto Sederhana</h4><p>Kuliner khas Padang</p><div class="fasilitas-price">Rumah Makan</div></div>
            </div>
        </div>
    </div>
</section>
...
<section id="lokasi" class="section bg-light">
    <div class="container">
        ...
        <div class="maps-section">
            <div class="maps-container"><iframe src="https://maps.google.com/maps?q=Muara,+Tapanuli+Utara&output=embed" allowfullscreen loading="lazy"></iframe></div>
            <div class="rute-info">
                <div class="rute-item"><h4>Motor</h4><p>Balige ke Ajibata (30m) ke Ferry (20m) ke Muara (15m)</p></div>
                <div class="rute-item"><h4>Mobil</h4><p>Balige ke Ajibata (30m) - Parkir - Ferry - Transportasi lokal</p></div>
                <div class="rute-item"><h4>Estimasi</h4><p>Dari Balige: sekitar 1.5 jam</p></div>
            </div>
        </div>
    </div>
</section>
...
<script>
    ...
    document.querySelectorAll('.nav-link[href^="#"], .mobile-link[href^="#"]').forEach(function(anchor) { anchor.addEventListener('click', function(e) { e.preventDefault(); var target = document.querySelector(this.getAttribute('href')); if (target) { window.scrollTo({ top: target.offsetTop - 80, behavior: 'smooth' }); } }); });
</script>
</body>
</html>
