...
<head>
    ...
    <style>
        ...
        h1, h2, h3, h4, h5, h6, .hero-title, .section-title h2, .display-heading {
            font-family: var(--font-display);
        }

        .section-subtitle, .subtitle, .nav-link, .navbar-brand, .btn, .footer h5, .dropdown-header,
        .small-uppercase, .badge, .card-title {
            font-family: var(--font-ui);
        }

        .accent-text, .eyebrow, .hero-subtitle, .section-note {
