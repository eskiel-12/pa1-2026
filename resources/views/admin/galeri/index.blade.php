...
<div class="management-header">
    <h5><i class="fas fa-images me-2" style="color: #c6a43b;"></i> Daftar Galeri</h5>
...
<div class="management-card management-table">
    ...
    <div class="table-responsive">
        <table class="table">
            <thead>
                <tr style="text-transform: uppercase; font-size: 0.85rem; letter-spacing: 0.5px;"><th>#</th><th>Gambar</th><th>Judul</th><th>Kategori</th><th>Status</th><th>Aksi</th></tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-2">
                            <a href="{{ route('admin.galeri.show', $item->id) }}" class="btn btn-sm" style="border: 1.5px solid #3b82f6; color: #3b82f6; background: transparent; border-radius: 6px;" title="Lihat"><i class="fas fa-eye"></i></a>
                            <a href="{{ route('admin.galeri.edit', $item->id) }}" class="btn btn-sm" style="border: 1.5px solid #f59e0b; color: #f59e0b; background: transparent; border-radius: 6px;"><i class="fas fa-edit"></i></a>
