...
<div class="container-fluid">
    <div class="management-header">
        <h2><i class="fas fa-car me-2" style="color: #c6a43b;"></i> Transportasi</h2>
        <a href="{{ route('admin.transportasi.create') }}" class="btn btn-primary-custom">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="d-flex gap-2 justify-content-center">
                                <a href="{{ route('admin.transportasi.show', $item->id) }}" class="btn btn-sm" style="border: 1.5px solid #3b82f6; color: #3b82f6; background: transparent; border-radius: 6px;">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('admin.transportasi.edit', $item->id) }}" class="btn btn-sm" style="border: 1.5px solid #f59e0b; color: #f59e0b; background: transparent; border-radius: 6px;">
